import { Car, DollarSign, MapPin, X } from 'lucide-react-native';
...
export function FilterModal({
  ...
  const prices = [
    ...
    { label: 'Hasta RD$2,000/h', value: '2000' },
    { label: 'Hasta RD$3,000/h', value: '3000' },
    { label: 'Más de RD$3,000/h', value: '3000+' },
  ];
