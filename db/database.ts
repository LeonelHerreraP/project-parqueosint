...
export class Database {
  ...
  private async checkAndMigrate(): Promise<void> {
    ...
    try {
      ...
      if (!hasDescription) {
        console.log(
          'Esquema desactualizado detectado, recreando base de datos...'
        );
        await this.recreateDatabase();
      }
    } catch (error) {
      console.log(
        'Error al verificar esquema, recreando base de datos...',
        error
      );
      await this.recreateDatabase();
    }
  ...
  private async seedData(): Promise<void> {
    ...
    const userCount = await this.db.getFirstAsync(
    ...
    const parkings = [
      {
        ...
        status: 'available',
        description:
          'Parqueo seguro en el corazón del centro comercial con acceso directo a todas las tiendas.',
      ...
      },
      {
        ...
        status: 'limited',
        description:
          'Parqueo municipal con tarifas accesibles y tecnología de sensores para facilitar encontrar espacios.',
      ...
      },
      {
        ...
        status: 'full',
        description:
          'Parqueo premium con servicio de valet parking y máxima seguridad para el distrito financiero.',
      ...
      },
      {
        ...
        status: 'available',
        description:
          'Amplio parqueo del estadio nacional con capacidad para eventos masivos y tarifas económicas.',
