    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsSection}>
          ...
          <View style={styles.statItem}>
            <Text style={styles.statNumber}>
              RD${user?.totalSpent?.toLocaleString() || '0'}
            </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.menuGroup}>
            <MenuItem
              ...
              onPress={() =>
                Alert.alert('Editar Email', 'Función en desarrollo')
              }
            />
            <MenuItem
              ...
              onPress={() =>
                Alert.alert('Editar Teléfono', 'Función en desarrollo')
              }
            />
            <MenuItem
              ...
              onPress={() =>
                Alert.alert('Mis Vehículos', 'Función en desarrollo')
              }
            />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.menuGroup}>
            <MenuItem
              ...
              onPress={() =>
                Alert.alert('Métodos de Pago', 'Función en desarrollo')
              }
            />
          </View>
        </View>
